...
public class WypozyczalniaTest {
    ...
    public void test_zwrocListeWynajetych() {
        ...
        // Opcja 2:
        // Konieczne było dopisanie EqualsAndHashCode.Exclude
        Assert.assertTrue("Wynajete 3 po wynajeciu powinien zawierać samochód 1", wynajete3.contains(sam1));
        Assert.assertTrue("Wynajete 3 po wynajeciu powinien zawierać samochód 1", wynajete3.get(0).getStatus() == StatusSamochodu.WYNAJETY);
    ...
    // 2. Dziala metoda sprawdzCeneSamochodu
    //  - Stwórz nowy obiekt Wypozyczalnia
